...
public class Domain
{
    ...
    private String FREEZE_OPERATOR;
    ...
    public String getFREEZE_OPERATOR() {
        return FREEZE_OPERATOR;
    }

    public void setFREEZE_OPERATOR(String FREEZE_OPERATOR) {
        this.FREEZE_OPERATOR = FREEZE_OPERATOR;
    }
    ...
    public String toString() {
        return ID + "\t" + DOMAIN_CODE + "\t" + PARENT_CODE + "\t" + UNIT_ID + "\t" + AREA_CODE + "\t" + DOMAIN_NAME + "\t" + DOMAIN_TYPE + "\t" + LINK_MAN + "\t" + PHONE + "\t" + ADDRESS + "\t" + PEOPLE_COUNT + "\t" + STATUS + "\t" + START_TIME + "\t" + USE_PERIOD + "\t" + UPDATE_TIME + "\t" + USER_ACCOUNT + "\t" + FREEZE_TIME + "\t" + FREEZE_OPERATOR + "\t" + EXT_1 + "\t" + EXT_2 + "\t" + EXT_3 + "\t" + EXT_4 + "\t" + EXT_5;
    }
}
